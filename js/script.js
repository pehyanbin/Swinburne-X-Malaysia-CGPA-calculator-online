...
function calculateGPA() {
    ...
    // Display results
    displayResults(results, roundTo(cgpa, 5), systemType);
}
...
function displayResults(results, cgpa, systemType) {
    ...
    results.forEach(sem => {
        resultsHTML += `
            <div class="sem-result-header">
                ...
                <span class="gpa-badge">GPA: ${sem.gpa.toFixed(5)}</span>
            </div>
    ...
    // Set CGPA
    document.getElementById('final-cgpa').textContent = cgpa.toFixed(5);
